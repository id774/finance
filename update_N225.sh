...
$PYTHON $WORK_DIR/bin/charts.py -a 1 -p 4 -c N225 -n 日経平均株価 -d 2014-01-01 -y 600 -r stock_N225.csv -u>>$JOBLOG 2>&1
$PYTHON $WORK_DIR/bin/charts.py -a 2 -p 3 -c N225 -n 日経平均株価 -d 2014-01-01 -y 240 -r stock_N225.csv>>$JOBLOG 2>&1
